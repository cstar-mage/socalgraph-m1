...
function Minicart(options) {
    ...
    this.selectors = {
        itemRemove:           '#cart-sidebar .remove, .cart .remove',
...
Minicart.prototype = {
    ...
    removeItem: function(el) {
        var cart = this;
        jQuery('.remove-item-from-cart').show();
        jQuery('.remove-item-from-cart-btn-yes').off('click').click(function (){
            cart.hideMessage();
            cart.showOverlay();
            $j.ajax({
                type: 'POST',
            ...
            jQuery(this).parents().find('.remove-item-from-cart').hide();

        });
        jQuery('.checkout-onepage-index .remove-item-from-cart-btn-yes, .checkout-cart-index .remove-item-from-cart-btn-yes').off('click').click(function (){
            cart.hideMessage();
            cart.showOverlay();
            $j.ajax({
                type: 'POST',
        ...
        jQuery('.remove-item-from-cart-btn-no, .remove-item-from-cart-close').off('click').click(function () {
            jQuery('.remove-item-from-cart').hide();
        });
