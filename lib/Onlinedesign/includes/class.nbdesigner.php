...
class Nbdesigner_Plugin {
    ...
    public function __construct() {
        ...
        $this->plugin_url_data = NBDESIGNER_DATA_URL . '/';
    }
    ...
    */    
    ...
    public function nbd_save_customer_design(){      
        ...
        $result = array();
        do_action('before_nbd_save_customer_design', null);
...
CREATE TABLE {$wpdb->prefix}nbdesigner_templates ( 
 ...
 PRIMARY KEY  (id) 
    ...
    public function nbdesigner_get_art(){
        ...
        foreach ($result['arts'] as $art) {
            $art->url = $this->plugin_url_data . $art->path;
        }
        echo json_encode($result);
        wp_die();        
    }
    public function nbdesigner_get_font(){ 	        
        ...
        foreach ($result['fonts'] as $font) {
            $font->url = $this->plugin_url_data . $font->path;
        }
