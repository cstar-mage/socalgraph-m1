...
class Blackbox_CinemaCLoud_Block_Csr_Order_History_Filter extends Mage_Core_Block_Template
{
    ...
    {
        $this->setTemplate('blackbox/cinemacloud/csr/order/history/filter.phtml');
    }
