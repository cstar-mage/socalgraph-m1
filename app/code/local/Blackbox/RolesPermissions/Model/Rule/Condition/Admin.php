...
/**
 * Admin rule condition data model
 *
 * @package Blackbox_RolesPermissions
 */
class Blackbox_RolesPermissions_Model_Rule_Condition_Admin extends Blackbox_RolesPermissions_Model_Rule_Condition_Admin_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('rolespermissions/rule_condition_admin');
    }
    /**
