 ...
 */
class Blackbox_RolesPermissions_Model_Rule_Condition_Customer_Attribute_Assigned extends Mage_Rule_Model_Condition_Product_Abstract
{
    /**
    ...
    protected function _getProduct(Varien_Object $object)
    {
        return $object->getProduct() instanceof Mage_Catalog_Model_Category
            ? $object->getProduct()
            : Mage::getModel('customer/customer')->load($object->getProductId());
    }
