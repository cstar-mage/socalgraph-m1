...
/**
 * Abstract Rule category condition data model
 *
 ...
 */
abstract class Blackbox_RolesPermissions_Model_Rule_Condition_Category_Abstract extends Mage_Rule_Model_Condition_Abstract
{
    /**
     ...
     *
     * @return Blackbox_RolesPermissions_Model_Rule_Condition_Category_Abstract
     */
     ...
     * @return Blackbox_RolesPermissions_Model_Rule_Condition_Category
     */
    public function collectValidatedAttributes($categoryCollection)
    {
        ...
        if ($this->getAttributeObject()->isScopeGlobal()) {
            ...
            $categoryCollection->addAttributeToSelect($attribute, 'left');
        } else {
            $this->_entityAttributeValues = $categoryCollection->getAllAttributeValues($attribute);
        }
    ...
    /**
     * Validate category attrbute value for condition
     *
    ...
    public function validate(Varien_Object $object)
    {
        ...
        if (!($object instanceof Mage_Catalog_Model_Category)) {
            $object = Mage::getModel('catalog/category')->load($object->getId());
        }
