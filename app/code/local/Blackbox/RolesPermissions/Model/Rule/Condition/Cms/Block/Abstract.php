...
/**
 * Abstract Rule cms block condition data model
 *
 ...
 */
abstract class Blackbox_RolesPermissions_Model_Rule_Condition_Cms_Block_Abstract extends Mage_Rule_Model_Condition_Abstract
{
    /**
    ...
    public function getAttributeObject()
    {
        try {
            $obj = Mage::getSingleton('eav/config')
                ->getAttribute('cms_block', $this->getAttribute());
        }
        catch (Exception $e) {
            $obj = new Varien_Object();
            $obj->setEntity(Mage::getResourceSingleton('cms/block'))
     ...
     *
     * @return Blackbox_RolesPermissions_Model_Rule_Condition_Cms_Block_Abstract
     */
    ...
    /**
     * Validate cms block attrbute value for condition
     *
    ...
    public function validate(Varien_Object $object)
    {
        ...
        if (!($object instanceof Mage_Cms_Model_Block)) {
            $object = Mage::getModel('cms/block')->load($object->getId());
        }
