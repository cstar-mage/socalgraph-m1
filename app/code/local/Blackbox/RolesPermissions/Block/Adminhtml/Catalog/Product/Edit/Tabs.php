...
class Blackbox_RolesPermissions_Block_Adminhtml_Catalog_Product_Edit_Tabs
    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            ...
            if (!Mage::helper('rolespermissions')->canViewPrices()) {
                $groupCollection->addFieldToFilter('attribute_group_name', array('neq' => 'Prices'));
            }

            $groupCollection->addFieldToFilter('attribute_group_name', array('neq' => 'Recurring Profile'))
                ->addFieldToFilter('attribute_group_name', array('neq' => 'Gift Options'));
...
//            }
    ...
    {
        return parent::addTab($tabId, $tab); // TODO: Change the autogenerated stub
    }
}