 ...
 */
abstract class Blackbox_OrderApproval_Model_Rule_Condition_Order_Abstract extends Mage_Rule_Model_Condition_Abstract
{
    /**
    ...
    public function getAttributeObject()
    {
        try {
            $obj = Mage::getSingleton('eav/config')
                ->getAttribute('sales_order', $this->getAttribute());
        }
        catch (Exception $e) {
