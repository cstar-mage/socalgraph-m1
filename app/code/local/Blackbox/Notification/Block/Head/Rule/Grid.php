 ...
 */
class Blackbox_Notification_Block_Head_Rule_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Initialize grid
     * Set sort settings
     ...
     * Set collection
     *
     * @return Blackbox_Notification_Block_Head_Rule_Grid
     */
    protected function _prepareCollection()
    {
        /** @var $collection Blackbox_Notification_Model_Resource_Notification_Rule_Collection */
        $collection = Mage::getModel('blackbox_notification/notification_rule')
