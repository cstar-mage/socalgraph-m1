...
class Blackbox_Notification_Block_Head_Rule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        $rule = Mage::registry('current_blackbox_notification_notification_rule');
        if ($rule->getRuleId()) {
