 ...
 */
class Blackbox_Notification_Block_Rule_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $model = Mage::registry('current_blackbox_notification_rule'); /* @var Blackbox_Notification_Model_Rule $model */
        ...
        Mage::dispatchEvent('adminhtml_blackbox_notification_edit_tab_main_prepare_form', array('form' => $form));
