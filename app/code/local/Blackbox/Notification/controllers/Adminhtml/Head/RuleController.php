...
class Blackbox_Notification_Adminhtml_Head_RuleController extends Mage_Adminhtml_Controller_Action
{
    protected function _initRule()
    {
        $this->_title($this->__('Promotions'))->_title($this->__('Notifications'));

        Mage::register('current_blackbox_notification_notification_rule', Mage::getModel('blackbox_notification/notification_rule'));
        ...
        if ($id) {
            Mage::registry('current_blackbox_notification_notification_rule')->load($id);
        }
    }
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('blackbox_notification/head_rule')
    ...
    {
        $this->_title($this->__('Notifications'))->_title($this->__('Notifications Rules'));
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel('blackbox_notification/notification_rule');
        if ($id) {
            $model->load($id);
            if (! $model->getRuleId()) {
        ...
        Mage::register('current_blackbox_notification_notification_rule', $model);
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            try {
                ...
                $model = Mage::getModel('blackbox_notification/notification_rule');
                Mage::dispatchEvent(
                    'blackbox_notification_controller_head_notification_prepare_save',
    ...
    public function newConditionHtmlAction()
    {
        ...
        $model = Mage::getModel($type)
            ->setId($id)
            ->setType($type)
            ->setRule(Mage::getModel('blackbox_notification/notification_rule'))
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/notification/head_rule');
    }
}
