 ...
 */
class Blackbox_Notification_Model_Resource_Rule extends Mage_Rule_Model_Resource_Abstract
{
    /**
    ...
    {
        $this->_init('blackbox_notification/rule', 'rule_id');
    }
     ...
     *
     * @return Blackbox_Notification_Model_Resource_Rule
     */
