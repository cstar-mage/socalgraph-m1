...
class Blackbox_Registration_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
     * Don't send password change email if is approving customer
     */
        ...
        if ($data) {
            ...
            try {
                ...
                if (!empty($data['account']['new_password'])) {
                    ...
                    if (!($customer->getApproved() && !$customer->getOrigData('approved'))) {
