 ...
 */
class Blackbox_EpaceImport_Model_Estimate_Total_Config_Base extends Blackbox_EpaceImport_Model_Config_Ordered
{
    /**
     ...
     * @return Blackbox_EpaceImport_Model_Estimate_Total_Abstract
     */
    protected function _initModelInstance($class, $totalCode, $totalConfig)
    {
        $model = Mage::getModel($class);
        if (!$model instanceof Blackbox_EpaceImport_Model_Estimate_Total_Abstract) {
            Mage::throwException(Mage::helper('sales')->__('Total model should be extended from Blackbox_EpaceImport_Model_Estimate_Total_Abstract.'));
        }
