 ...
 */
class Blackbox_EpaceImport_Block_Adminhtml_PurchaseOrder_Comments_View extends Mage_Adminhtml_Block_Template
{
    /**
     ...
     *
     * @return Blackbox_EpaceImport_Block_Adminhtml_PurchaseOrder_Invoice_Create_Items
     */
        ...
        switch ($this->getParentType()) {
            case 'invoice':
                return Mage::helper('epacei')->canSendInvoiceCommentEmail(
                    $this->getEntity()->getPurchaseOrder()->getStore()->getId()
                );
            case 'shipment':
