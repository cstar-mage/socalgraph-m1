<?php
  ...
  * Totals item block
  */
class Blackbox_EpaceImport_Block_Adminhtml_PurchaseOrder_Totals_Item extends Blackbox_EpaceImport_Block_Adminhtml_PurchaseOrder_Totals
{
    /**
     * Determine display parameters before rendering HTML
     *
     * @return Blackbox_EpaceImport_Block_Adminhtml_PurchaseOrder_Totals_Item
     */
    ...
    {
        return $this->helper('adminhtml/sales')->displayPrices($this->getPurchaseOrder(), $baseAmount, $amount);
    }
