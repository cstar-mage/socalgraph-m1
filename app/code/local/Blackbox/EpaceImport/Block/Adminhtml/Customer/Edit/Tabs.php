        ...
        */
        ...
        if (Mage::registry('current_customer')->getId()) {
            ...
            if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/view')) {
                ...
                $this->addTab('estimates', array(
                    'label'     => Mage::helper('customer')->__('Estimates'),
                    'class'     => 'ajax',
                    'url'       => $this->getUrl('*/*/estimates', array('_current' => true)),
                ));
                $this->addTab('shipments', array(
                    'label'     => Mage::helper('customer')->__('Shipments'),
                    'class'     => 'ajax',
                    'url'       => $this->getUrl('*/*/shipments', array('_current' => true)),
                ));
            }
