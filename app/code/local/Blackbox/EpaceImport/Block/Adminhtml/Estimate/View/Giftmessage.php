...
/**
 * Edit estimate giftmessage block
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Blackbox_EpaceImport_Block_Adminhtml_Estimate_View_Giftmessage extends Mage_Adminhtml_Block_Widget
{
    /**
    ...
    {
        if ($this->getParentBlock() && ($estimate = $this->getOrder())) {
            $this->setEntity($estimate);
        }
     ...
     *
     * @return Blackbox_EpaceImport_Block_Adminhtml_Estimate_View_Giftmessage
     */
    ...
    public function getEntity()
    {
        if(is_null($this->_entity)) {
            $this->setEntity(Mage::getModel('giftmessage/message')->getEntityModelByType('estimate'));
    ...
    {
        return 'giftmessage_estimate_' . $this->getEntity()->getId() . '_';
    }
    ...
    {
        return $this->getUrl('*/epacei_estimate_view_giftmessage/save',
            array(
    ...
    public function canDisplayGiftmessage()
    {
        return $this->helper('giftmessage/message')->getIsMessagesAvailable(
            'estimate', $this->getEntity(), $this->getEntity()->getStoreId()
        );
    }
