...
/**
 * Adminhtml sales estimate column renderer
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Blackbox_EpaceImport_Block_Adminhtml_Estimate_Items_Column_Default extends Mage_Adminhtml_Block_Template
{
    public function getItem()
    {
        if ($this->_getData('item') instanceof Blackbox_EpaceImport_Model_Estimate_Item) {
    ...
    public function getEstimateOptions()
    {
        $result = array();
