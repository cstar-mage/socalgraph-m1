...
/**
 * Create estimate status form
 */
class Blackbox_EpaceImport_Block_Adminhtml_Estimate_Status_New_Form extends Mage_Adminhtml_Block_Widget_Form
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('new_estimate_status');
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset   = $form->addFieldset('base_fieldset', array(
            'legend'    => Mage::helper('epacei')->__('Order Status Information')
        ));
        ...
        $fieldset->addField('status', 'text',
            array(
                'name'      => 'status',
                'label'     => Mage::helper('epacei')->__('Status Code'),
        ...
        $fieldset->addField('label', 'text',
            array(
                'name'      => 'label',
                'label'     => Mage::helper('epacei')->__('Status Label'),
        ...
        $fieldset = $form->addFieldset('store_labels_fieldset', array(
            'legend'       => Mage::helper('epacei')->__('Store View Specific Labels'),
        ...
        $form->setAction($this->getUrl('*/epacei_estimate_status/save'));
