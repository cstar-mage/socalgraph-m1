...
class AW_Rma_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    # Allow autoapprove RMA request
    const G_AUTOAPPROVE = 'awrma/general/autoapprove';
    # Allow Cancel option
    const G_ALLOWCANCEL = 'awrma/general/enable_cancel';
    ...
    const G_ALLOWATTACH = 'awrma/general/allow_attach';
    ...
    public static function getAllowAutoApproveRequest($store = null)
    {
        return (bool)Mage::getStoreConfig(self::G_AUTOAPPROVE, $store);
    }

    public static function getAllowCancel($store = null)
    {
        return (bool)Mage::getStoreConfig(self::G_ALLOWCANCEL, $store);
    }
    ...
    public static function getAllowAttachments($store = null)
    {
        return (bool)(Mage::getStoreConfig(self::G_ALLOWATTACH, $store));
    }
