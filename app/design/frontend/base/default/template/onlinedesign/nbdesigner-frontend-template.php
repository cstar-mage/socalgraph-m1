    ...
    <head>
        ...
        <script type="text/javascript">
            var NBDESIGNCONFIG = {
                ...
                ajax_url    : "<?php echo $this->getUrl('onlinedesign/index/nbdesigner_get_product_info', array('_current'=>true, '_secure' => $this->getRequest()->isSecure())); ?>",
                nonce   :   "<?php echo wp_create_nonce('save-design'); ?>",
                nonce_get   :   "<?php echo wp_create_nonce('nbdesigner-get-data'); ?>",
                product_data  :   <?php echo json_encode(nbd_get_product_info($session ?: $user_id, $product_id, 0, $task, $session ? $product_id : $reference_product, $template_folder, $order_id, $order_item_folder)); ?>
            };                  
